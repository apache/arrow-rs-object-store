...
# the files in the tarball are prefixed with {release} (e.g. apache-arrow-object-store-rs-0.4.0)
mkdir -p ${distdir}
...
[ ] +0
[ ] -1 Do not release this as Apache Arrow Rust Object Store ${object_store_version} because...
